...
public class WebAPI {
    ...
    public static String browserStack_userName = "arafatrahman2";
    public static String browserStack_accessKey = "sXSSNknxvEjBD1xS5u3u";
    public static String sauceLabs_userName = "arafat147";
    public static String sauceLabs_accessKey = "9366bf44-f95b-4a55-a014-d0fa8fa03745";
